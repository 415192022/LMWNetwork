    ...
    protected <T> Function<T, T> getAppErrorHandler() {
        return new Function<T, T>() {
            ...
            public T apply(T response) throws Exception {
                ...
                if (response instanceof Test1BaseResponse && ((Test1BaseResponse) response).showapiResCode != 0) {
                    ServerException exception = new ServerException();
                    exception.code = ((Test1BaseResponse) response).showapiResCode;
                    exception.message = ((Test1BaseResponse) response).showapiResError != null ? ((Test1BaseResponse) response).showapiResError : "";
                    throw exception;
                }
                return response;
            }
